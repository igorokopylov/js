...
let firstNumber = prompt('Задача: Запросить 2 числа и найти только наибольший общий делитель. Напишите первое число');
let secondNumber = prompt('Задача: Запросить 2 числа и найти только наибольший общий делитель. Напишите второе число');
let m; //большее число
let n; //меньшее число

console.log("Задача: Запросить 2 числа и найти только наибольший общий делитель.");
